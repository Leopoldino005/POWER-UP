...
class DDL:  # Manipulação da Tabela
    def conecta_bd(self):
        self.con = sqlite3.connect('pup_dates.db')   # Conectando com o Banco de Dados do Aplicativo
        self.cur = self.con.cursor()  # Cursor de busca no Banco de Dados
    ...
    def insere_user(self, nome, email, senha):
        self.cria_tabela()
        self.cur.execute('''
